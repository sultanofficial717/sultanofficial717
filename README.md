...
Large-scale research system fusing a ~490K-file Portuguese news corpus with CMO/PLD electricity price data to predict 45-day price deviations. GPU-accelerated translation, NLP feature extraction, and topic modeling across 20 energy-domain categories.
...
### ⚡ AI Automation Suite
Workflow automation systems built around modern LLMs to reduce manual operational overhead for agency clients.
...
Co-authored with Adil Khan &#8226; Submitted to an Elsevier journal, addressing Major Revision
...
Co-authored with Adil Khan &#8226; Targeting Q1 venues (IEEE CS, ACM CSUR)
